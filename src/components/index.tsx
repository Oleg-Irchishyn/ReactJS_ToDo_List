...
export { default as SingleTask } from './Tasks/SingleTask/';
export { default as AddTasksForm } from './Tasks/AddTasksForm';
...
export { default as AllTasksItem } from './TasksItems/AllTasksItem';
